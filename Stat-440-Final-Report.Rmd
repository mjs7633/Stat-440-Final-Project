...
mod_nb <- naiveBayes(happy ~ wealthy+social_support+life_expectancy+freedom+generosity+corruption+gdp_per_capita, data = train)
...
mod_nnet <- nnet(happy ~ wealthy+social_support+life_expectancy+freedom+generosity+corruption+gdp_per_capita, data = train, size = 7)
